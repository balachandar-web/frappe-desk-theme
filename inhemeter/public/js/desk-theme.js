...
// 	frm.set_df_property("desk_theme", "options", ["Dark", "Light", "Automatic", "Custom", "Green"]);
...
frappe.ui.ThemeSwitcher = class ThemeSwitcher {
	...
	fetch_themes() {
		return new Promise((resolve) => {
			this.themes = [
				...
				{
					name: "green",
					label: __("Farmland Green"),
					info: __("Farmland Green"),
				},
				{
					name: "lavender",
					label: __("Lavender"),
	...
	toggle_theme(theme) {
		...
		frappe.show_alert(__("Theme Changed to " + toTitle(theme)), 3);
